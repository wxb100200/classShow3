...
import com.hz.school.model.CoursePlan;
...
public class GSCourseDao {
    ...
    private static void parseOneRow(Row row, int startColumn, int endColumn){
        String rname="";
        List<CoursePlan> courseList=new ArrayList<CoursePlan>();
        for(int i=startColumn;i<endColumn;i++){
            ...
            if(i==startColumn){
                ...
                List<CoursePlan> courses=generateCourseList(str,rname,i);
    ...
    private static List<CoursePlan> generateCourseList(String str, String rname, int i){
        List<CoursePlan> courseList=new ArrayList<CoursePlan>();
