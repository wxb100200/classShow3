...
public class TotalCourseDao {
    ...
    private static void parseOneRow(Row row,Row row2,String sheetName,int startColumn,int endColumn){
        ...
        for(int i=startColumn;i<endColumn;i++){
            ...
            TotalCourse totalCourse=generateTotalCourse(sheetName,classInfo,obj,obj2,i);
            if(totalCourse!=null){
    ...
    private static TotalCourse generateTotalCourse(String sheetName, ClassInfo classInfo, Object obj1, Object obj2, int i){
